...
public class AddressGenerator extends AbstractGenerator {
    private final List<String> cities = ReaderFile.readByLine(config.getProperties().getProperty("city"));
    private final List<String> streets = ReaderFile.readByLine(config.getProperties().getProperty("streets"));
    private final List<String> disctricts = ReaderFile.readByLine(config.getProperties().getProperty("disctrict"));
    private final List<String[]> subject = ReaderFile.parseCsv(config.getProperties().getProperty("subject"));
